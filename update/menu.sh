...
echo -e "${cyan}>${NC}\e[34m Waktu              \e[0m    :  $jam WIB ${NC}"
echo -e "${GREEN}══════════════════════════════════════════════════════════${NC}"
...
echo -e "${GREEN}══════════════════════════════════════════════════════════${NC}"
 echo -e  "${GREEN}  ╠═════════════════════════════════════════════════╣"
 echo -e  "${GREEN}  ║                   ${cyan}• INFO MENU  •                ${GREEN}║"
 echo -e  "${GREEN}  ╠═════════════════════════════════════════════════╣"
 echo -e  " ${GREEN} ║\e[0m01. Panel SSH & OpenVPN  $bl    "
 echo -e  " ${GREEN} ║\e[0m02. Panel Vmess & Vless $bl  "
 echo -e  " ${GREEN} ║\e[0m03. Panel Trojan  $bl    "
 echo -e  " ${GREEN} ║\e[0m04. Add Subdomain For Vps $gl  "
 echo -e  " ${GREEN} ║\e[0m05. Renew Certificate V2ray $bl   "
 echo -e  " ${GREEN} ║\e[0m06. Change Port All Acount  $bl  "
 echo -e  " ${GREEN} ║\e[0m07. Cek Status Layanan  $gl   "
 echo -e  " ${GREEN} ║\e[0m08. Webmin Menu $gl  "
 echo -e  " ${GREEN} ║\e[0m09. Cek Bandwith Harian  $gl  "
 echo -e  " ${GREEN} ║\e[0m10. Reboot Vps $gl  "
 echo -e  " ${GREEN} ║\e[0m11. Speedtest $mg  "
 echo -e  " ${GREEN} ║\e[0m12. Info Script Port Install $mg   "
 echo -e  " ${GREEN} ║\e[0m13. Info Script Auto Install $mg   "
 echo -e  " ${GREEN} ╠═════════════════════════════════════════════════╣"
 echo -e  " ${GREEN} ║${cyan} SCRIPT BY ARYA BLITAR II                        ${GREEN}║"
 echo -e  " ${GREEN} ╚═════════════════════════════════════════════════╝\e[0m"
echo -e  ""
